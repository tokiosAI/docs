...
<ParamField body="ConnectorId" type="string" required>
  The connector's id from the console (e.g. `con_...`). Identifies this connector to the Tokios gateway.
</ParamField>

<ParamField body="Token" type="string" required>
  The connector token issued when you create the connector (e.g. `ct-...`), bound to your tenant. Shown only once in the console.
</ParamField>
